...
def are_create_barchart_params_valid(x_data:numpy.ndarray, y_data:numpy.ndarray, width:float, colour:list, xlabel:str,
                                     title:str, fig_id:int, sub_id:int, ylabel:str, series_name:list, show=True,
                                     type_of_bar='s'):
    """Check the parameters for create_barchart are valid
...
def create_barchart(x_data:numpy.ndarray, y_data:numpy.ndarray, width:float, colour:list, xlabel:str, title:str,
    ...
    """
    # validate parameters
    if are_create_barchart_params_valid(x_data, y_data, width, colour, xlabel, title, fig_id, sub_id, ylabel,
                                        series_name, show, type_of_bar):
